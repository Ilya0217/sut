...
/*
Назначение: Обработка POST /api/auth/login
Входные данные: JSON {username, password}
Выходные данные: JSON {id, username, email, role} + cookie session
*/
...
/*
Назначение: Обработка POST /api/auth/register
Входные данные: JSON {username, email, password, role?}
Выходные данные: JSON {id, username, email, role} + cookie session (201)
*/
...
/*
Назначение: Обработка POST /api/auth/logout
Входные данные: cookie session
Выходные данные: JSON {message: "OK"} + сброс cookie
*/
...
/*
Назначение: Обработка GET /api/auth/me
Входные данные: cookie session
Выходные данные: JSON {id, username, email, role} или 401
*/
static void handle_me(const httplib::Request& req, httplib::Response& res)
{
